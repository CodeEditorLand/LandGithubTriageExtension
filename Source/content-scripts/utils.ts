...
export const expectClickable = <T>(o: T): Clickable & T =>
	typeof (o as any)?.click === "function"
		? (o as Clickable & T)
		: error("expeted clickbale", o);

export const awaitClickable = async <T>(
	getter: () => T,
	tries = 25,
...
export const awaitFalsey = async (
	getter: () => any,
	tries = 25,
): Promise<void> => {
	if (tries === 0) return;
...
export const getCurrentRepo = () =>
	/https:\/\/github.com\/([^/]*\/[^/]*)\/(?:issues|pull)\/\d*/.exec(
