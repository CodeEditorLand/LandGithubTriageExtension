...
import { delay, expectDefined } from "../common/utils";
import { awaitClickable, awaitFalsey, expectClickable } from "./utils";
...
export const toggleLabel = (label: string) =>
	toggleMenu(
		"#labels-select-menu summary",
		"#labels-select-menu .name",
		label,
	);

export const toggleMilestone = (milestone: string) =>
	toggleMenu(
		"#milestone-select-menu summary",
		"#milestone-select-menu .select-menu-item-heading",
		milestone,
	);
...
export const toggleAssignee = (assignee: string) =>
	toggleMenu(
		...
		".select-menu-item-heading > .js-username",
		assignee,
	);
